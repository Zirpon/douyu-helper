...
// @copyright           zepung
// @license             MIT
// @match               https://wiki.dota2.com.cn/
// @run-at              document-idle
// @supportURL          https://github.com/Zirpon/douyu-helper
// @homepage            https://github.com/Zirpon/douyu-helper
...
;// CONCATENATED MODULE: ./src/dota2_act3/act3_token.js
var act3 = {
  flame: {
    3: ['phoenix'],
    2: ['clinkz', 'lina'],
    1: ['batrider', 'brewmaster', 'dawnbreaker', 'doom_bringer', 'ember_spirit', 'gyrocopter', 'huskar', 'jakiro', 'ogre_magi', 'nevermore', 'snapfire', 'abyssal_underlord']
  },
  frost: {
  ...
  nature: {
    ...
    1: ['brewmaster', 'dark_willow', 'earthshaker', 'enchantress', 'hoodwink', 'leshrac', 'lone_druid', 'meepo', 'furion', 'night_stalker', 'nyx_assassin', 'obsidian_destroyer', 'puck', 'shredder', 'ursa', 'viper', 'windrunner']
  },
  "void": {
    3: ['bane'],
    2: ['faceless_void', 'obsidian_destroyer', 'nevermore', 'spectre', 'void_spirit'],
    1: ['chaos_knight', 'dark_seer', 'elder_titan', 'enigma', 'life_stealer', 'muerta', 'night_stalker', 'slark', 'spirit_breaker', 'templar_assassin', 'abyssal_underlord', 'weaver']
  },
  blood: {
    3: ['pudge'],
  ...
  mystic: {
    ...
    1: ['abaddon', 'bounty_hunter', 'chen', 'dark_willow', 'dawnbreaker', 'dazzle', 'death_prophet', 'disruptor', 'invoker', 'wisp', 'magnataur', 'medusa', 'muerta', 'night_stalker', 'ogre_magi', 'oracle', 'puck', 'pugna', 'rubick', 'shadow_demon', 'silencer', 'skywrath_mage', 'vengefulspirit', 'winter_wyvern', 'witch_doctor']
  },
  armor: {
    3: [],
    2: ['axe', 'doom_bringer', 'omniknight'],
    1: ['abaddon', 'bristleback', 'centaur', 'chaos_knight', 'chen', 'rattletrap', 'dawnbreaker', 'dragon_knight', 'drow_ranger', 'ember_spirit', 'faceless_void', 'gyrocopter', 'legion_commander', 'luna', 'lycan', 'mirana', 'nyx_assassin', 'phantom_lancer', 'queenofpain', 'skywrath_mage', 'spirit_breaker', 'storm_spirit', 'sven', 'shredder', 'treant', 'undying', 'visage', 'skeleton_king']
  },
  helmet: {
    3: [],
    2: [],
    1: ['arc_warden', 'rattletrap', 'huskar', 'legion_commander', 'luna', 'mars', 'phantom_assassin', 'silencer', 'skywrath_mage', 'sven', 'techies', 'shredder', 'tinker', 'troll_warlord', 'undying']
  },
  shield: {
    3: [],
    2: ['pangolier', 'tinker'],
  ...
  cape: {
    3: [],
    2: [],
    1: ['crystal_maiden', 'drow_ranger', 'invoker', 'legion_commander', 'lion', 'marci', 'furion', 'omniknight', 'phantom_assassin', 'pugna', 'rubick', 'shadow_demon', 'sniper', 'windrunner', 'skeleton_king']
  },
  mask: {
    3: [],
    2: [],
    1: ['batrider', 'bloodseeker', 'bounty_hunter', 'bristleback', 'grimstroke', 'gyrocopter', 'juggernaut', 'razor', 'rubick', 'shadow_shaman', 'sniper', 'templar_assassin']
  },
  fur: {
    3: [],
    2: ['earthshaker', 'magnataur', 'monkey_king'],
    1: ['beastmaster', 'centaur', 'enchantress', 'hoodwink', 'leshrac', 'lone_druid', 'lycan', 'mirana', 'riki', 'spirit_breaker', 'tusk', 'ursa']
  },
  scale: {
    3: [],
    2: ['primal_beast', 'slardar', 'viper'],
    1: ['dragon_knight', 'jakiro', 'medusa', 'pangolier', 'puck', 'slark', 'snapfire', 'terrorblade', 'tidehunter', 'abyssal_underlord', 'venomancer', 'winter_wyvern']
  },
  minion: {
    3: [],
    2: ['broodmother', 'enigma', 'visage', 'warlock'],
    1: ['beastmaster', 'chen', 'clinkz', 'death_prophet', 'enchantress', 'wisp', 'lycan', 'monkey_king', 'muerta', 'furion', 'undying', 'weaver']
  },
  illusion: {
    3: [],
    2: ['naga_siren', 'phantom_lancer', 'terrorblade'],
    1: ['chaos_knight', 'dark_seer', 'elder_titan', 'ember_spirit', 'grimstroke', 'hoodwink', 'keeper_of_the_light', 'morphling', 'spectre', 'vengefulspirit']
  },
  ward: {
    3: [],
  ...
  partner: {
    3: [],
    2: ['meepo'],
    1: ['alchemist', 'arc_warden', 'batrider', 'dark_willow', 'elder_titan', 'wisp', 'lone_druid', 'marci', 'mirana', 'ogre_magi', 'snapfire', 'techies']
  }
};
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/dota2_act3/assets/styles.css
var styles = __webpack_require__(9839);
;// CONCATENATED MODULE: ./src/dota2_act3/assets/styles.css
...
function initHeroToken() {
  ...
  for (var i = 0; i < heroElements2.snapshotLength; i++) {
    ...
    var tokenList = dota2_act3_dota2_heros[name].act3_tag;
...
var BaseClass = /*#__PURE__*/function () {
  ...
  _createClass(BaseClass, [{
    ...
    value: function gray(imgObj, height, width) {
      ...
      canvas.width = imgW;
      canvas.height = imgH; //console.log(imgW, imgH);
...
var fastKey = (__webpack_require__(5375).fastKey);
...
var InternalMetadataModule = __webpack_require__(5375);
var iterate = __webpack_require__(8734);
var anInstance = __webpack_require__(767);
var isCallable = __webpack_require__(9985);
var isNullOrUndefined = __webpack_require__(981);
...
var getOwnPropertyNamesExternalModule = __webpack_require__(6062);
var isExtensible = __webpack_require__(1129);
var uid = __webpack_require__(4630);
var FREEZING = __webpack_require__(1594);
...
var isObject = __webpack_require__(8999);
var classof = __webpack_require__(6648);
var ARRAY_BUFFER_NON_EXTENSIBLE = __webpack_require__(1655);
...
var fails = __webpack_require__(3689);
var uncurryThis = __webpack_require__(8844);
var objectGetPrototypeOf = __webpack_require__(1868);
var objectKeys = __webpack_require__(300);
var toIndexedObject = __webpack_require__(5290);
var $propertyIsEnumerable = (__webpack_require__(9556).f);
...
var $ = __webpack_require__(9989);
var $entries = (__webpack_require__(9419).entries);
...
var fails = __webpack_require__(3689);
var toObject = __webpack_require__(690);
var nativeGetPrototypeOf = __webpack_require__(1868);
var CORRECT_PROTOTYPE_GETTER = __webpack_require__(1748);
...
var $ = __webpack_require__(9989);
var $parseFloat = __webpack_require__(4818);
...
var collectionStrong = __webpack_require__(800);
